    ...
    var DialogDefinition = {
      ...
      contents: [{
        ...
        elements: [{
          ...
          required: true,
          validate: CKEDITOR.dialog.validate.notEmpty('Please enter the math expression.'),
          onLoad: function onLoad() {
          ...
          setup: function setup(widget) {
            var _widget$parseMath2 = widget.parseMath(widget.data.math),
                displayMode = _widget$parseMath2.displayMode;
