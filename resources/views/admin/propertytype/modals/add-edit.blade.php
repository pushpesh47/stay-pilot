<div class="modal fade" id="propertytypeModal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ route('admin.propertytype.store') }}" id="propertytypeForm" autocomplete="off"
